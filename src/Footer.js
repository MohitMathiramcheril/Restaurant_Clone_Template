                ...
                <div className="row g-5">
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <div className="position-relative mx-auto" style={{maxwidth: "400px"}}>
                            ...
                            <button type="button" className="btn btn-warning py-2 position-absolute top-0 end-0 mt-2 me-2 text-light">SignUp</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="copyright">
                    <div className="row">
                        <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
							...
							Designed By <a className="border-bottom" href="https://htmlcodex.com">MOHIT</a><br/><br/>
                            Distributed By <a className="border-bottom" href="https://themewagon.com" target="_blank">MOHIT</a>
                        </div>
